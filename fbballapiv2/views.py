...
def avrFrames(teamsdf):
    ...
    pg = t[t['Pos'].str.contains('PG')]
    sg = t[t['Pos'].str.contains('SG')]
    sf = t[t['Pos'].str.contains('SF')]
    pf = t[t['Pos'].str.contains('PF')]
    c = t[t['Pos'].str.contains('C')]

    avf = pd.DataFrame(columns = t.columns, index = ["PG","SG","SF","PF","C","A"])
